...
APP_DIR="${APP_DIR:-/opt/lumia-scriptor-rag}"
REPO_URL="${REPO_URL:-https://github.com/clementzhang29/lumia-scriptor-rag.git}"
...
cat > /etc/nginx/sites-available/lumia-scriptor-rag <<NGINX
server {
    listen 80;
