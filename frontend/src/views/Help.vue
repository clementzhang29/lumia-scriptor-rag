  ...
  <div class="help-page">
    <section class="hero-panel">
      ...
      <p class="hero-subtitle">
        这里是 Lumia ScriptorRAG 的内置说明书：适合普通用户照着完成 OCR、排版、知识源挂载与 RAG 建库，也方便开发者理解项目结构并继续扩展智能体能力。
      </p>
    </section>
    ...
    <NAlert type="info" :bordered="false" class="card-shadow">
      ...
      产品名称和发布名称统一为 <strong>Lumia ScriptorRAG｜序光文枢 RAG</strong>。
    </NAlert>
    ...
    <NCard class="card-shadow">
      ...
      <div class="migration-grid migration-grid-wide">
        ...
        <div class="migration-card">
          ...
          <p>如需保留上传记录与索引，可复制 <NCode code="%LOCALAPPDATA%\\Lumia ScriptorRAG" />。</p>
        </div>
        <div class="migration-card">
          <NIcon><CloudDownload /></NIcon>
          <strong>4. 恢复挂载缓存</strong>
          <p>如使用知识源挂载，可复制 <NCode code="%LOCALAPPDATA%\\Lumia ScriptorRAG\\kb_mounts" />，或在新电脑重新挂载。</p>
        </div>
        <div class="migration-card">
      ...
      <NCollapse style="margin-top:18px">
        <NCollapseItem title="推荐迁移清单" name="move-list">
          <ul class="help-list">
            ...
            <li>可选复制：<NCode code="%LOCALAPPDATA%\\Lumia ScriptorRAG\\rag_db" /> 与 <NCode code="%LOCALAPPDATA%\\Lumia ScriptorRAG\\kb_mounts" />。</li>
